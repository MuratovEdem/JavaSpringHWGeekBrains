...
public class TimerAspect {
    ...
    @Pointcut("@annotation(org.example.javaspringhwgeekbrains.seminar5.aspect.Timer)") // method
    public void timerMethodsPointcut() {}

    @Pointcut("@within(org.example.javaspringhwgeekbrains.seminar5.aspect.Timer)") // class
